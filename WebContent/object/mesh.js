...
Mesh.prototype = {
  ...
  initCustomRender: function (customTexture, shaders)
  {
	  this.render_.initBuffers();
	  this.render_.reflectionLoc_ = customTexture;
	  this.render_.shader_.type_ = Shader.mode.Custom;
	  this.render_.shader_.init(shaders);
	  this.render_.updateBuffers();
  },
